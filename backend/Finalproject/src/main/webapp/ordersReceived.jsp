...
<html>
<body style="background-image:url('https://static.vecteezy.com/system/resources/previews/001/988/350/non_2x/abstract-dark-grey-metallic-cyber-pattern-on-black-design-modern-technology-futuristic-background-illustration-vector.jpg');">
<head>
...
<body>
<div style="color: white; text-align: center; font-size: 30px;">Orders Received <i class="fas fa-archive"></i>
<%
...
<div style="color:#ADD8E6; font-size: 13px;" >
<table style="width: 100%" id="customers" bordercolor="#FFFFF7" >
          <tr>
          <th>Mobile Number</th>
